import { render } from '@arietta-studio/arietta-cli-ui';
...
program
  ...
  .addOption(new Option('-o, --option', 'Setup arietta-compass preferences'))
  .addOption(new Option('-i, --init', 'Initialize arietta-compass as a commit hook'))
